...
<body id="Page-Body">
                ...
                <nav class="navbar navbar-light navbar-expand sticky-top bg-white shadow mb-4 topbar static-top" id="Navigation-Bar" style="height: 90px;padding-left: 0px;margin-bottom: 0px;padding-bottom: 8px;">
                    <div class="container-fluid" id="Navbar-Container">
                        <form class="form-inline d-none d-sm-inline-block mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search" id="Navbar-MenuSection" style="width: 100%;">
                            <div id="Navbar-ButtonGroup" class="input-group" style="width: 100%;"><img id="Site-Logo" src="assets/img/SYSTIMP/LazeRosa%20Logo.png" style="width: 100pxpx;height: 90px;">
                                    ...
                                    <div
                                        ...
                                        <a
                                            class="dropdown-item d-block" role="presentation" id="CustOrderList-Link" href="customerorderlist.php" style="height: 50px;margin-top: 5px;width: auto;"><img class="d-block" id="CustOrderList-Icon" src="assets/img/CustOrderList.png" style="width: 20px;"><span id="CustOrderList-Text">Customer Order List</span></a><a class="dropdown-item d-block" role="presentation" id="CustTracker-Link"
                                                href="customerordertracker" style="height: 50px;margin-top: 5px;"><img class="d-block" id="CustTracker-Icon" src="assets/img/CustTracker.png" style="width: 20px;"><span id="CustTracker-Text">Customer Order Tracker</span></a></div>
                            </li>
    ...
    <div class="container-fluid" id="Page-Content">
        ...
        <div class="d-sm-flex align-items-center mb-4" id="Page-Header"><img id="Page-Header-Icon" src="assets/img/SYSTIMP/ViewInv.png" style="width: 35px;margin-left: 0px;margin-right: 15px;margin-top: 0px;padding-top: 0px;padding-bottom: 0px;">
            <h3 class="text-dark mb-0" id="Page-Header-Title" style="color: rgb(0,0,0);font-family: ABeeZee, sans-serif;font-weight: bold;font-size: 35px;">View Inventory</h3>
        </div>
        <div class="card shadow" id="ViewInv_Table">
            <div class="card-header py-3" id="Table-Header" style="background-color: rgb(235,235,235);">
                <p class="text-center text-primary m-0 font-weight-bold" id="Table-HeaderTitle" style="font-size: 30px;font-weight: bold;font-family: 'Open Sans', sans-serif;color: #ffafaf;">Our Inventory</p>
                <div class="row" id="Table-HeaderDetails">
                    <div class="col" id="Table-HeaderDetail-1">
                        <p class="text-right m-0 font-weight-bold" id="Table-TodayDate-Intro" style="font-size: 15px;width: 100%;font-family: 'Open Sans', sans-serif;color: rgb(133,135,150);font-weight: normal;">As of TODAY:&nbsp;</p>
                    </div>
                    <div class="col" id="Table-HeaderDetail-2">
                        <p class="text-left m-0 font-weight-bold" id="Table-TodayDate" style="font-size: 15px;width: 100%;font-family: 'Open Sans', sans-serif;color: rgb(133,135,150);font-weight: lighter;">TodayDate<script>
        var d = new Date();
        ...
        document.getElementById("Table-TodayDate").innerHTML = d.toDateString();
            ...
            <div class="card-body" id="Table-Body">
                <div class="row" id="Table-Tools">
                    <div class="col-md-6 text-nowrap" id="Table-Tool1"><!-- this is show  -->
                ...
                <div class="table-responsive table mt-2" id="ViewInv-TableFrame" role="grid" aria-describedby="dataTable_info">
                    <table class="table my-0" id="ViewInv-Table">
                        <thead id="Table-Header">
                            <tr id="Table-HeaderRow" style="background-color: #a7caff;font-family: Nunito, sans-serif;color: rgb(0,0,0);">
                        ...
                        <?php
                            ...
                            $a = ceil($a);
                            for($b=1; $b <= $a; $b++){
                                ?><a href = "viewinventory.php?page=<?php echo $b; ?>" style="text-decoration:none"><?php echo $b.""; ?></a><?php
                            }

                        ?>
                            <tr id="Table-Row">
                                <td id="Checkbox-Entry"><input type="checkbox" id="Checkbox-EntryItem"></td>
                                <td id="Brand-Entry">Product ID</td>
                    ...
                    <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable" role="document" id="AddInv-Modal">
                        <div class="modal-content" id="AddInv-ModalContent">
                            <div class="modal-header" id="AddInv-ModalHeader" style="background-color: rgb(28,200,138);color: rgb(255,255,255);font-family: 'Open Sans', sans-serif;">
                                <h4 id="AddInv-Title" style="font-size: 30px;font-weight: normal;margin-top: 8px;">Add Inventory</h4><button type="button" class="close" data-dismiss="modal" aria-label="Close" id="AddInv-CloseButton"><span aria-hidden="true">×</span></button></div>
                            <div class="modal-body" id="AddInv-ModalBody">
                                <div class="table-responsive table mt-2" id="ViewInv-AddTableFrame" role="grid" aria-describedby="dataTable_info" style="width: auto;">
                                    <table class="table my-0" id="ViewInv-AddTable">
                                        ...
                                        <tr id="AddTable-Row">
                                            <form  method="post">
                                                <td id="ProductName-InputEntry"><input class="bg-white border rounded border-white" type="text" id="ProductName-Input" placeholder="Product ID" name="pid" style="width: 100%;height: 100%;padding-bottom: 0px;padding-top: 0px;"
                                            ...
                                            <?php
                                                ...
                                                if(isset ($_POST["confirm"])){
                                                    ...
                                                    $pqty = $_POST["pqty"];
                                                    $preorder = $_POST["prp"];
                                                    $add = "INSERT INTO tblinventory (pID, pName, pBrand, pQuantity, pReorderPoint) 
                                                        VALUES ('$pid', '$pname', '$pbrand', '$pqty', '$preorder')";
